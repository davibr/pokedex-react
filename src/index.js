...
const POKEMON = 1;
const REQUEST_ROOT = "https://pokeapi.co/api/v2/";
const POKEMON_REQUEST_ROOT = REQUEST_ROOT + "pokemon/";
...
class Pokedex extends React.Component {
    ...
    changePokemon() {
        ...
        const request = `${POKEMON_REQUEST_ROOT}${this.state.pokemonIndex}/`;
        fetch(request, {
            cache: "force-cache"
        })
...
class PokemonSprite extends React.Component {
    ...
    buildImage() {
        ...
        const shiny = this.state.shiny ? "_shiny" : "";
        const defaultStr = (gender + shiny) ? "" : "_default";
        //console.log(dir + shiny + gender + defaultStr);
        return dir + shiny + gender + defaultStr;
    }
...
function ButtonChrome(props) {
    return (
        <div className="panel-row blue-buttons">
            <div className="blue-button active"><p>Attacks</p></div>
